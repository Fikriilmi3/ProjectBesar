...
public class CHATALO extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chatalo);
        ...
        pDialog       = new ProgressDialog(CHATALO.this);

        namaanak.setText(Preferences.getKeyNamaAnak(CHATALO.this));
        namaibu.setText(Preferences.getKeyNamaIbu(CHATALO.this));
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(CHATALO.this, CHATActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void LoadPertanyaan(int nosoal){
        ...
        RequestQueue queue = Volley.newRequestQueue(CHATALO.this);
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, ServerApi.URL_PERTANYAANCHATA + nosoal, null, new Response.Listener<JSONArray>() {
            @Override
        ...
        StringRequest updateReq = new StringRequest(Request.Method.POST, ServerApi.URL_SIMPAN_HASIL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        pDialog.cancel();
                        AlertDialog.Builder builder = new AlertDialog.Builder(CHATALO.this);
                        builder.setTitle("Simpan Data").
                                setMessage("Hasil Tes anda disimpan");
                        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                Intent intent = new Intent(CHATALO.this, CHATActivity.class);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        pDialog.cancel();
                        androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(CHATALO.this);
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("id_user", Preferences.getKeyId(CHATALO.this));
