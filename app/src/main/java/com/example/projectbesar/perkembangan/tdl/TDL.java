...
public class TDL extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tdl2);

        tdl           = findViewById(R.id.tdlpertanyaan);
        hasil         = findViewById(R.id.tdlhasil);
        ...
        pDialog       = new ProgressDialog(TDL.this);

        namaanak.setText(Preferences.getKeyNamaAnak(TDL.this));
        namaibu.setText(Preferences.getKeyNamaIbu(TDL.this));
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(TDL.this, TDLActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void LoadPertanyaan(int nosoal){
        ...
        RequestQueue queue = Volley.newRequestQueue(TDL.this);
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, ServerApi.URL_PERTANYAANTDL + nosoal, null, new Response.Listener<JSONArray>() {
            @Override
    ...
    private void LoadHasil(String sstatus){
        ...
        RequestQueue queue = Volley.newRequestQueue(TDL.this);
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, ServerApi.URL_HASILTDL + sstatus, null, new Response.Listener<JSONArray>() {
            @Override
            public void onResponse(JSONArray response) {
                for (int i = 0; i < response.length(); i++){
                    pDialog.cancel();
        ...
        StringRequest updateReq = new StringRequest(Request.Method.POST, ServerApi.URL_SIMPAN_HASIL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        pDialog.cancel();
                        AlertDialog.Builder builder = new AlertDialog.Builder(TDL.this);
                        builder.setTitle("Simpan Data").
                                setMessage("Hasil Tes anda disimpan");
                        builder.setPositiveButton("OK",
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                        Intent intent = new Intent(TDL.this, TDLActivity.class);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        pDialog.cancel();
                        androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(TDL.this);
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("id_user", Preferences.getKeyId(TDL.this));
