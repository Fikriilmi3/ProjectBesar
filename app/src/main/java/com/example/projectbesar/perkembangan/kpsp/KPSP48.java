...
public class KPSP48 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kpsp48);
        ...
        pDialog       = new ProgressDialog(KPSP48.this);

        namaanak.setText(Preferences.getKeyNamaAnak(KPSP48.this));
        namaibu.setText(Preferences.getKeyNamaIbu(KPSP48.this));
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(KPSP48.this, KPSPActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void LoadPertanyaan(int nosoal){
        ...
        RequestQueue queue = Volley.newRequestQueue(KPSP48.this);
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, ServerApi.URL_PERTANYAANKPSP48 + nosoal, null, new Response.Listener<JSONArray>() {
            @Override
        ...
        StringRequest updateReq = new StringRequest(Request.Method.POST, ServerApi.URL_SIMPAN_HASIL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        pDialog.cancel();
                        AlertDialog.Builder builder = new AlertDialog.Builder(KPSP48.this);
                        builder.setTitle("Simpan Data").
                                setMessage("Hasil Tes anda disimpan");
                        builder.setPositiveButton("OK",
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                        Intent intent = new Intent(KPSP48.this, KPSPActivity.class);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        pDialog.cancel();
                        androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(KPSP48.this);
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("id_user", Preferences.getKeyId(KPSP48.this));
