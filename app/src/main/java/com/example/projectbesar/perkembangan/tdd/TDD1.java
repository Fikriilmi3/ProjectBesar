...
public class TDD1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tdd1);
        ...
        pDialog       = new ProgressDialog(TDD1.this);

        namaanak.setText(Preferences.getKeyNamaAnak(TDD1.this));
        namaibu.setText(Preferences.getKeyNamaIbu(TDD1.this));
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(TDD1.this, TDDActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void LoadPertanyaan(int nosoal){
        ...
        RequestQueue queue = Volley.newRequestQueue(TDD1.this);
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, ServerApi.URL_PERTANYAANTDD1 + nosoal, null, new Response.Listener<JSONArray>() {
            @Override
        ...
        StringRequest updateReq = new StringRequest(Request.Method.POST, ServerApi.URL_SIMPAN_HASIL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        pDialog.cancel();
                        AlertDialog.Builder builder = new AlertDialog.Builder(TDD1.this);
                        builder.setTitle("Simpan Data").
                                setMessage("Hasil Tes anda disimpan");
                        builder.setPositiveButton("OK",
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                        Intent intent = new Intent(TDD1.this, TDDActivity.class);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        pDialog.cancel();
                        androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(TDD1.this);
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("id_user", Preferences.getKeyId(TDD1.this));
