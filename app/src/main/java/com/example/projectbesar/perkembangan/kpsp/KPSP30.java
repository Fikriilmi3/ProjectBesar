...
public class KPSP30 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kpsp30);
        ...
        pDialog       = new ProgressDialog(KPSP30.this);

        namaanak.setText(Preferences.getKeyNamaAnak(KPSP30.this));
        namaibu.setText(Preferences.getKeyNamaIbu(KPSP30.this));
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(KPSP30.this, KPSPActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void LoadPertanyaan(int nosoal){
        ...
        RequestQueue queue = Volley.newRequestQueue(KPSP30.this);
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, ServerApi.URL_PERTANYAANKPSP30 + nosoal, null, new Response.Listener<JSONArray>() {
            @Override
        ...
        StringRequest updateReq = new StringRequest(Request.Method.POST, ServerApi.URL_SIMPAN_HASIL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        pDialog.cancel();
                        AlertDialog.Builder builder = new AlertDialog.Builder(KPSP30.this);
                        builder.setTitle("Simpan Data").
                                setMessage("Hasil Tes anda disimpan");
                        builder.setPositiveButton("OK",
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                        Intent intent = new Intent(KPSP30.this, KPSPActivity.class);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        pDialog.cancel();
                        androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(KPSP30.this);
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("id_user", Preferences.getKeyId(KPSP30.this));
